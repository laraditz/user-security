...
namespace Laraditz\UserSecurity\Traits;

use Illuminate\Support\Facades\Hash;
use Laraditz\UserSecurity\Services\MnemonicService;
...
trait UserSecurable
{
    ...
    {
        return $this->hasOne('Laraditz\UserSecurity\Models\UserSecurity', 'model_id')->where('model_type', get_class($this));
    }
